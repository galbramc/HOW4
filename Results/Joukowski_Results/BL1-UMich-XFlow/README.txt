...
Adaptation on drag using output adjoints.

AdaptP.txt: order (p) refinement, output-based on drag, fixed fraction
(15%), starting from ref1 of the provided quadrilateral mesh sequence.

Tri-MOESS-p#.txt: output-based triangular mesh optimization using
MOESS-like approach with several iterations at roughly fixed dof
